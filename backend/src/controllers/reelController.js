...
// // -------------------------------------------------------
// // 2. GET REELS FEED (With Pagination) 🚀
// // -------------------------------------------------------
// exports.getAllReels = async (req, res) => {
//   try {
//     const currentUserId = req.user.id;
...
//     const limit = 5; // Ek baar mein sirf 5 Reels aayengi
//     const skip = (page - 1) * limit;

//     // ... (Friend Logic Same rahega) ...
//     const friendships = await Friendship.find({ /* ... same ... */ });
//     const friendIds = friendships.map( /* ... same ... */ );

//     // Query wahi purani
//     const reels = await Reel.find({
//       $or: [
//         { visibility: "public" },
//         { visibility: "private", author: { $in: friendIds } },
//         { author: currentUserId }
//       ]
//     })
//       .populate("author", "name avatar photoURL")
//       .sort({ createdAt: -1 })
//       .skip(skip)   // 👈 Kitne chodne hain
//       .limit(limit); // 👈 Kitne lane hain

//     res.status(200).json({ 
//       success: true, 
//       reels,
//       hasMore: reels.length === limit // Frontend ko batao ki aur data hai ya nahi
//     });
